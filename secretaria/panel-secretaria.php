...
try {
    ...
    $stmt = $conn->prepare("SELECT u.usr, u.rol, u.logia, u.password_reset_required, l.logia AS logia_tex 
    FROM usuarios u LEFT JOIN logias l ON u.logia = l.clave_logia WHERE u.usrId = ?");
...
<head>
  ...
  <title>SIGAM | Panel Secretaría</title>
  <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet" />
  <link rel="stylesheet" href="../css/panel-secretaria.css"> 
    ...
    <p class="text-xs opacity-90">Sistema Integral de Gestión Administrativa Masónica</p>
      ...
      <div class="flex items-center space-x-6">
        <div class="hidden md:flex items-center space-x-2 bg-white/20 px-4 py-2 rounded-full">
          <span class="text-sm font-medium"><?php if($_SESSION['rol'] === 'venerable'){$_SESSION['rol'] = 'Venerable Maestro';}echo htmlspecialchars($_SESSION['user_name']); ?></span>
...
<div class="text-center max-w-3xl mx-auto">
    <p class="text-xl text-gray-600 mb-8">
       Panel de control de Secretaría. ¿Qué deseas hacer hoy?
    </p>
...
<section class="container mx-auto px-6 pb-16">
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
    ...
    <a href="../secretaria/" class="glass-card p-8 text-center group">
      ...
      <h3 class="text-xl font-bold text-gray-800 mb-2">Registro de Secretaría</h3>
    ...
    <a href="../actas/" class="glass-card p-8 text-center group">
      ...
      <a href="../reportes/expediente//" class="glass-card p-8 text-center group">
      <div class="feature-icon bg-purple-100 text-purple-600 mx-auto group-hover:bg-purple-600 group-hover:text-white">
        <i data-lucide="file-text" class="w-6 h-6"></i>
      </div>
      <h3 class="text-xl font-bold text-gray-800 mb-2">Expediente de Hermanos</h3>
      <p class="text-gray-600 mb-4">Revisar Expediente de Hermanos</p>
      <div class="text-purple-500 font-medium flex items-center justify-center group-hover:text-purple-600">
        <span>Acceder</span>
        <i data-lucide="arrow-right" class="w-4 h-4 ml-2"></i>
      </div>
    ...
    <a href="../Ver-actas/" class="glass-card p-8 text-center group">
      ...
      <h3 class="text-xl font-bold text-gray-800 mb-2">Mostrar Actas/Expedientes</h3>
