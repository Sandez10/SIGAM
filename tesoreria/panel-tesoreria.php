...
<head>
  ...
  <title>SIGAM | Panel Tesorería</title>
...
<section class="container mx-auto px-6 pb-16">
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
    ...
    <a href="../tesoreria/" class="glass-card p-8 text-center group">
      ...
      <img src="../icons/crossed-feathers.svg" alt="Secretaría" class="w-6 h-6">
      </div>
    ...
    <a href="../reporte-tesoreria/" class="glass-card p-8 text-center group">
      ...
      <h3 class="text-xl font-bold text-gray-800 mb-2">Generar Reporte de Tesorería</h3>
      <p class="text-gray-600 mb-4">Concentrado General de Movimiento</p>
